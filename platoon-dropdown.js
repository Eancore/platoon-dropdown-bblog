...
LoadPlatoonList : function(instance) {
    ...
    else
    {
      $.each(platoondropdownstoredplatoonsmenu, function(index,value) {
        ...
        platoondropdownmenucode += '<div class="radar" style="color: #fff !important; background-color: transparent !important; border-bottom: 0"><div class="source-url">' + item[0] + ' - ' + item[1] +'</div><span class="bblog-button tiny delete pd-delete" data-pdindex="'+index+'">' + BBLog.t("delete") + '</span></div>';        
      });
    }
